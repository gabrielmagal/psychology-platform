...
public class PaymentUseCaseImpl implements PaymentUseCase {
    ...
    public List<PaymentEntity> filteredFindPaged(String tenant, UserEntity loggedUser, Filter filter, int page, int size) {
        if (loggedUser.getUserType() == br.com.psicologia.domain.entity.enums.UserType.PSICOLOGO) {
        ...
        if (loggedUser.getUserType() == br.com.psicologia.domain.entity.enums.UserType.PACIENTE) {
